...
// Validate checks every physical input of the config and resolves the fuel
// name against the registry. It returns a descriptive error for the first
// failing rule.
...
// MustResolveFuel resolves the fuel and panics only when the validation
// step was skipped; production callers always validate first.
